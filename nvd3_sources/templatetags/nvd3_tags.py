...
from nvd3_sources.nvd3.NVD3Chart import NVD3Chart
from nvd3_sources.nvd3 import lineWithFocusChart, lineChart, \
...
def load_chart(chart_type, series, container, kw_extra, *args, **kwargs):
	...
	**kw_extra settings**::
	...
	if not 'x_axis_format' in kw_extra:
		if 'x_is_date' in kw_extra and kw_extra['x_is_date'] == True:
			kw_extra['x_axis_format'] = "%d %b %Y"
		else:
			kw_extra['x_axis_format'] = ""
